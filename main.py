...
def main():
    ...
    args.metrics_calculator = MetricsCalculator[args.model_type](args)

    # Dataset.
    args.logger.info("Loading train dataset...")
    args.train_data_loader = get_loader(args, model=0)
    args.logger.info("Loading valid dataset...")
    args.valid_data_loader = get_loader(args, model=1)
    args.logger.info("Loading test dataset...")
    args.test_data_loader = get_loader(args, model=2)
